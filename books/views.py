...
from books.utils.views_utils import (filter_books,
                                            get_language_object,
                                            get_author_object,
                                            )
...
class AllBooksView(View):
    def get(self, request):
        ...
        return render(request, 'books/all_books.html', context={'books': page_obj})


class AddBookView(View):
    def get(self, request):
        form = AddBookForm()
        return render(request, 'books/base_form.html', context={'form': form, 'submit': 'ADD'})
...
class ImportFromApiView(View):
    def get(self, request):
        ...
        return render(request, 'books/base_form.html', context={'form': form, 'submit': 'Import'})
